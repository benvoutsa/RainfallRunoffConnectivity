...
# LOAD RUNOFF DATA
# ---------------------------------------------------
tree_00_06 = dtree.open_datatree(os.path.join(DATA_DIR, "runoff", "runoff_2000_2006.nc"))
tree_07_13 = dtree.open_datatree(os.path.join(DATA_DIR, "runoff", "runoff_2007_2013.nc"))
tree_14_24 = dtree.open_datatree(os.path.join(DATA_DIR, "runoff", "runoff_2014_2024.nc"))
